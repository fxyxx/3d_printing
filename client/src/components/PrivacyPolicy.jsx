      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to 3D_Future, Gagarina ave, 20, office 311.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 3D_Future, accessible from{" "}
            <a
      ...
      <ul>
        <li>
          <p>
            ...
            <a
              href="http://www.mycompany.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
        ...
        <li>
          <p>By phone number: +380980980968</p>
        </li>
      </ul>
    </div>
  );
