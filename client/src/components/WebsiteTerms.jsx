...
const WebsiteTerms = () => {
  return (
    <div>
      <p>
        The 3D_Future website located at 3D_Future.com is a copyrighted work
        belonging to 3D_Future. Certain features of the Site may be subject to
      ...
      <p>
        ...
        the Company should be sent to: Gagarina ave, 20, office 311. After the
      ...
      <p>
        ...
        the personal jurisdiction of the courts located within ua County,
      ...
      <p>Address: Gagarina ave, 20, office 311</p>
      <p>Email: 3D_Future@gmail.com</p>
    </div>
  );
};
